...
In Kapitel 2, \nameref{sec:state_of_the_art}, wird ein Überblick über existierende Transferfunktionen und deren Funktionsweisen gegeben.
Kapitel 3, \nameref{sec:methods}, beschäftigt sich mit der in dieser Arbeit verwendeten Transferfunktion.
In Kapitel 4, \nameref{sec:concept}, wird das Softwaredesign der Implementierung erklärt.
In Kapitel 5, \nameref{sec:implementation}, die Umsetzung dessen besprochen.
In Kapitel 6, \nameref{sec:results}, werden die Resultate dieser Arbeit gezeigt und evaluiert.
In Kapitel 7, \nameref{sec:discussion}, werden die Ergebnisse diskutiert.
