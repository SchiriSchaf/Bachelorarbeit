...
Transferfunktionen, die auf zweidimensionalen Histogramme basieren, sind häufig verwendet. Das am meisten benutzte Histogramm basiert auf den \textit{scalar value}, den Intensitätswerten und \textit{gradientmagnitude}, der Länge der Gradienten.
